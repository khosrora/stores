...
SECRET_KEY = 'django-insecure-5--vtedz5br%8ox3z05b4a9us_a^!4!=itupgm8tw0)665bbfl'
...
CELERY_BROKER_URL = 'amqp://guest:guest@rabbitmq_container_store:5672//'
CELERY_RESULT_BACKEND = None  # No result backend needed without database
